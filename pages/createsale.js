      ...
      <div className="overflow-x-hidden text-white" >
        <div className="h-screen content-center" style={{"backgroundImage":`url(${Brand.bg1})`,"backgroundPosition":"center","backgroundSize":"cover","backgroundRepeat":"no-repeat"}} >
          ...
          <div class="container h-full content-center flex flex-wrap mx-auto items-center justify-center align-middle items-center ">
            ...
            <div className="w-full md:w-1/2 mt-16 items-center bg-gray-900 bg-opacity-80 shadow px-20 pt-10 pb-20 rounded-lg">
              <div className="w-full">
                <h3 className="lg:text-5xl text-xl font-extrabold mb-6 leading-tight text-heading-blue text-left">Create Sale</h3>
              </div>
              ...
              <input value={title} onChange={e => setTitle(e.target.value)} className="mt-8 my-2 p-3 w-full bg-gray-900 rounded text-white placeholder-gray-300" placeholder="Enter Category"/>
              <input value={title} onChange={e => setTitle(e.target.value)} className="mt-8 my-2 p-3 w-full bg-gray-900 rounded text-white placeholder-gray-300" placeholder="Enter Duration in Hours"/>
              <input value={title} onChange={e => setTitle(e.target.value)} className="mt-8 my-2 p-3 w-full bg-gray-900 rounded text-white placeholder-gray-300" placeholder="Enter Max. No. of entries"/>

              <button onClick={submitForm} className="mt-4 px-8 py-3 rounded font-extrabold bg-gradient-to-tr from-blue-500 via-purple-500 to-red-500">
